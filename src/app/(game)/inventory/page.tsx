...
import { Swords, Shield, Package, PawPrint } from "lucide-react";

const typeIcons: Record<string, typeof Swords> = { weapon: Swords, armor: Shield, consumable: Package, tool: Swords };
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-tribal-900/50 p-5 rounded-lg border border-tribal-800/50 text-center">
            <Swords size={28} className="text-tribal-500 mx-auto mb-2" />
          ...
          <div className="bg-tribal-900/50 p-5 rounded-lg border border-tribal-800/50 text-center">
            <Shield size={28} className="text-tribal-500 mx-auto mb-2" />
        ...
        {!character.inventory || character.inventory.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
            {character.inventory.map((inv: any) => {
              const Icon = typeIcons[inv.item?.type] || Package;
              return (
      ...
      <div className="card">
        ...
        {!character.pets || character.pets.length === 0 ? (
          <div className="text-center py-6">
            <PawPrint size={32} className="text-tribal-700 mx-auto mb-2" />
            ...
            {character.pets.map((pet: any) => (
              <div key={pet.id} className="bg-tribal-900/50 p-3 rounded-lg flex items-center justify-between border border-tribal-800/50">
                <div className="flex items-center gap-3">
                  <PawPrint size={18} className="text-tribal-400" />
